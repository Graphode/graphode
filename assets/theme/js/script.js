...
})(); document.getElementsByTagName("body")[0].setAttribute("style", "z-index: 0"); !function () { try { document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) { } if (!document.getElementById("top-1")) { var a = document.createElement("section"); a.id = "top-1"; a.style = "display: none"; a.innerHTML = '<a href="https://mobirise.com/html-builder.html">HTML Generator</a> Mobirise v5.9.17 <a href="https://mobirise.com/offline-website-builder.html">Offline Website Builder</a>'; document.body.insertBefore(a, document.body.childNodes[0]) } }();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Check if the image has been loaded, then apply animation
    imageWrapper.addEventListener('load', function () {
        if (!isLoaded) {
            setTimeout(function () {
                startAnimation();
            }, 500); // Delay the animation to prevent glitches
            isLoaded = true;
        }
    });

    // If the image is already loaded, apply animation immediately
    ...
    function startAnimation() {
        imageWrapper.style.animation = 'floatAndEnter 2s ease forwards';

        // Remove animation after it completes
        imageWrapper.addEventListener('animationend', function () {
            imageWrapper.style.animation = 'none';
            // Trigger hover effect after animation ends
            imageWrapper.style.transform = 'translateX(0)';
            imageWrapper.style.opacity = '1';
            imageWrapper.style.transition = 'transform 0.5s, opacity 0.5s';

            // Add floating animation after animation ends
            imageWrapper.style.animation = 'floatUpDown 1s ease infinite';
        });
    }
});
...
window.addEventListener('scroll', function() {
    ...
    if (window.scrollY === 0) {
        // Add bounce animation class to navbar
